                    ...
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item dropdown">
                            ...
                            <ul className="dropdown-menu">
                                ...
                                <li><Link className="dropdown-item" to="/category/wildlife">Wildlife</Link></li>
                                <li><Link className="dropdown-item" to="/category/nature">Nature</Link></li>
                                <li><Link className="dropdown-item" to="/category/lifestyle">Lifestyle</Link></li>
                            </ul>
                        </li>
                    </ul>
                    <form className="d-flex" role="search">
                        <Link className="nav-link text-info mx-3 my-2" to="/login">Login</Link>
                        <input
